...
public class CreateProblemTypeAdapter extends ArrayAdapter<CreateService.Data.ProblemType> {

    private final LayoutInflater mInflater;
    private final Context mContext;
    private final List<CreateService.Data.ProblemType> items;

    public CreateProblemTypeAdapter(@NonNull Context context, @NonNull List<CreateService.Data.ProblemType> objects) {
...
//        super(context, R.layout.row_item_spinner, 0, objects);
    ...
    public void updateBrand(List<CreateService.Data.ProblemType> brandList) {

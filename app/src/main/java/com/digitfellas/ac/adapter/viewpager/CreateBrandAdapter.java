...
public class CreateBrandAdapter extends ArrayAdapter<CreateService.Data.Brand> {

    private final LayoutInflater mInflater;
    private final Context mContext;
    private final List<CreateService.Data.Brand> items;

    public CreateBrandAdapter(@NonNull Context context, @NonNull List<CreateService.Data.Brand> objects) {
...
//        super(context, R.layout.row_item_spinner, 0, objects);
    ...
    public void updateBrand(List<CreateService.Data.Brand> brandList) {
...
//        notifyDataSetChanged();
    ...
    private View createItemView(int position, View convertView, ViewGroup parent){
        ...
        CreateService.Data.Brand category = items.get(position);
        if (position==0){

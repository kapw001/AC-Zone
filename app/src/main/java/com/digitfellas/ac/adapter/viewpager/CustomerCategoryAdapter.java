...
public class CustomerCategoryAdapter extends ArrayAdapter<CreateOrderForDealer.Data.Customer> {

    private final LayoutInflater mInflater;
    private final Context mContext;
    private final List<CreateOrderForDealer.Data.Customer> items;

    public CustomerCategoryAdapter(@NonNull Context context, @NonNull List<CreateOrderForDealer.Data.Customer> objects) {
...
//        super(context, R.layout.row_item_spinner, 0, objects);
    ...
    private View createItemView(int position, View convertView, ViewGroup parent){
        ...
        CreateOrderForDealer.Data.Customer category = items.get(position);

        item_view.setText(category.getName());

...
public class CreateStateAdapter extends ArrayAdapter<CreateService.Data.State> {

    private final LayoutInflater mInflater;
    private final Context mContext;
    private final List<CreateService.Data.State> items;

    public CreateStateAdapter(@NonNull Context context, @NonNull List<CreateService.Data.State> objects) {
...
//        super(context, R.layout.row_item_spinner, 0, objects);
    ...
    public void updateBrand(List<CreateService.Data.State> brandList) {
...
//        notifyDataSetChanged();
    ...
    private View createItemView(int position, View convertView, ViewGroup parent){
        ...
        CreateService.Data.State category = items.get(position);
        if (position==0){
        ...
        item_view.setText(category.getStateName());

...
public class MultipleLayoutMyTaskDetailsAdapter extends BaseAdapter<Object, RecyclerView.ViewHolder> {

    protected MultipleLayoutMyTaskDetailsAdapter(List<Object> list) {
        super(list);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (getValue(viewType) instanceof TaskDetailsActivity.Data) {
        ...
        } else if (getValue(viewType) instanceof TasksDetails.Data.TaskComment) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (getValue(position) instanceof TaskDetailsActivity.Data) {

            TaskDetailsActivity.Data detail = (TaskDetailsActivity.Data) getList().get(position);

            ((ViewHolderProduct) holder).title.setText(detail.title + "");
            ((ViewHolderProduct) holder).description.setText(detail.des + "");


        } else if (getValue(position) instanceof TasksDetails.Data.TaskComment) {
            TasksDetails.Data.TaskComment comment = (TasksDetails.Data.TaskComment) getList().get(position);

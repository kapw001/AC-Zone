...
public class MultipleLayoutMyServicesDetailsAdapter extends BaseAdapter<Object, RecyclerView.ViewHolder> {

    protected MultipleLayoutMyServicesDetailsAdapter(List<Object> list) {
        super(list);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (getValue(viewType) instanceof MyServiceDetailsActivity.Data) {
        ...
        } else if (getValue(viewType) instanceof CustomerServicesDetails.Data.ServiceComment) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (getValue(position) instanceof MyServiceDetailsActivity.Data) {

            MyServiceDetailsActivity.Data detail = (MyServiceDetailsActivity.Data) getList().get(position);

            ((ViewHolderProduct) holder).title.setText(detail.title + "");
            ((ViewHolderProduct) holder).description.setText(detail.des + "");


        } else if (getValue(position) instanceof CustomerServicesDetails.Data.ServiceComment) {
            CustomerServicesDetails.Data.ServiceComment comment = (CustomerServicesDetails.Data.ServiceComment) getList().get(position);

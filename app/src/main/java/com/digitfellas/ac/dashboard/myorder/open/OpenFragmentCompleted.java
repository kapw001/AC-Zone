...
import static com.digitfellas.ac.dashboard.myorder.open.OpenFragment.KEY_REFRESH_RESULT_CODE;

/**
 * A simple {@link Fragment} subclass.
 */
public class OpenFragmentCompleted extends BaseFragment implements PaginationAdapter.OnItemClickListener {
...
//        customMessageView.showMessage();
    ...
    public void setUserVisibleHint(boolean visible) {
        ...
        Log.e(TAG, "setUserVisibleHint: openCom " + visible);
//
    ...
    private void loadDataFirstTime() {
        ...
        dataSource.loadMyOrder(param, currentPage + "", 2 + "", new DataListener() {
            @Override
            public void onSuccess(Object object) {

                OpenFragmentCompleted.super.onSuccess(object);
...
//                        customMessageView.showMessage();
            ...
            public void onFail(Throwable throwable) {
                OpenFragmentCompleted.super.onFail(throwable);
                isLoading = false;
                myOderAdapter.removeLoadingFooterCheck();

                customMessageView.showMessage();

                customMessageView.setMessageTitle("Oops");
                customMessageView.setMessageDescription("Something went wrong");
            ...
            public void onNetworkFailure() {
                OpenFragmentCompleted.super.onNetworkFailure();
                customMessageView.showMessage();

                customMessageView.setMessageTitle("No Internet");
                customMessageView.setMessageDescription("There is no Internet,please check your internet connection");
